...
int main (int argc, char **argv)
{
  ...
  if(!strcmp(systemLangauge, "eesEnglish"))
  {
    ...
    printf("            <input type =\"text\" name =\"eesNickname\" size =\"32\" maxlength =\"64\">");
    printf("          </td>");
    printf("        </tr>");
    printf("        <tr>");
    printf("          <td align =\"right\">");
    ...
    printf("          </td>");
    printf("          <td align =\"left\">");
    printf("            <input type =\"password\" name =\"eesPassword\" size =\"32\" maxlength =\"32\">");
    printf("          </td>");
    printf("        </tr>");
    printf("        <tr>");
    ...
    printf("              <a href =\"cgis/eesShowRegisterNewUserform.cgi?eesLanguage=english\"> Register </a>");
    printf("            </td>");
    printf("            <td style=\"text-align: center; font-family: arial; font-size: 15px;\">");
    printf("              <a href =\"cgis/eesShowRecoveryPasswordform.cgi?eesLanguage=english\"> Recover Password </a>");
    printf("            </td>");
    printf("            <td style=\"text-align: right; font-family: arial; font-size: 15px;\">");
    printf("              <a href = \"cgis/eesShowHelp.cgi?eesLanguage=english\"> Help </a>");
    printf("            </td>");
    printf("          </tr>");
    printf("      </form>");
    printf("    </table>");
